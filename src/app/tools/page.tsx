...
export default function ToolsPage() {
    ...
    const toolDescriptions: Record<string, string> = {
        ...
        'pdf-splitter': 'Split a PDF into individual pages or custom ranges. Download as separate files or a ZIP archive.',
        'pdf-rotator': 'Rotate PDF pages by 90°, 180°, or 270°. Fix scanned documents with incorrect orientation.',
        'pdf-compress': 'Compress PDF files to reduce size by stripping metadata and optimizing storage. Compare before/after.',
        'pdf-from-images': 'Convert multiple images (JPG, PNG, WebP) into a single PDF. Reorder, choose page size and orientation.',
        'pdf-page-numbers': 'Add page numbers to any PDF. Choose position, format (1 of N), font size, and skip cover page.',
        'pdf-watermark': 'Add text watermarks to every page with customizable opacity, rotation, color, and tiled patterns.',
        'pdf-protect': 'Password-protect PDF files with user/owner passwords and permission controls for printing and copying.',
        'pdf-unlock': 'Remove password protection from PDF files. Supply the current password to unlock and save unprotected.',
        'pdf-organize': 'Visually reorder, delete, and reorganize PDF pages with drag-and-drop thumbnail interface.',
        'pdf-to-image': 'Convert PDF pages to high-quality images (JPG, PNG). Perfect for presentations and social media.',
