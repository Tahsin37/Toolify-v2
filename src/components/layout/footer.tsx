...
export function Footer() {
    ...
    return (
        <footer className="bg-white border-t border-slate-100 pt-12 md:pt-16 lg:pt-20 pb-8 md:pb-12">
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 md:gap-12 lg:gap-8 mb-12 md:mb-16">
                        ...
                        <div className="flex space-x-3 md:space-x-4">
                            {[Twitter, Github, Linkedin].map((Icon, i) => (
                                <a
                                    key={i}
                                    href="#"
                                    className="h-9 w-9 md:h-8 md:w-8 flex items-center justify-center rounded-full bg-slate-100 text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 transition-all"
                                >
                    ...
                    {/* Links Columns */}
                    <div>
                        <h4 className="font-bold text-slate-900 mb-4 md:mb-6 text-sm">Tools</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 mb-4 md:mb-6 text-sm">Company</h4>
                        <ul className="space-y-2 md:space-y-3 text-sm text-slate-500">
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 mb-4 md:mb-6 text-sm">Legal</h4>
                        <ul className="space-y-2 md:space-y-3 text-sm text-slate-500">
                    ...
                    <div className="lg:col-span-1 sm:col-span-2 lg:col-span-1">
                        <div className="bg-slate-50 rounded-2xl p-4 md:p-6 border border-slate-100">
                            ...
                            <div className="flex items-center space-x-2 text-sm text-slate-600 mb-3 md:mb-4">
                ...
                <div className="pt-6 md:pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0 text-sm text-slate-400">
                    <p>&copy; {currentYear} Toolify All rights reserved.</p>
                    <div className="flex space-x-4 md:space-x-6">
                        <Link href="#" className="hover:text-slate-600 transition-colors">Sitemap</Link>
