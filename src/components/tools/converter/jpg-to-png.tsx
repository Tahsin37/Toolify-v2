...
export function JpgToPng() {
    ...
    const downloadFile = () => {
        ...
        link.href = converted;
        link.download = file?.name.replace(/\.jpe?g$/i, '.png') || 'converted.png';
        link.click();
    };
        ...
        <div className="space-y-6">
            ...
            >
                ...
                <p className="text-lg font-medium text-slate-700 mb-1">
                    {file ? file.name : 'Drop your JPG file here'}
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="p-4 bg-white border border-slate-200">
                        <h3 className="text-sm font-medium text-slate-700 mb-3 flex items-center">
                            <ImageIcon className="h-4 w-4 mr-2" /> Original JPG
                        </h3>
            ...
            <Card className="p-4 bg-blue-50 border border-blue-200">
                <p className="text-sm text-blue-700">
                    <strong>Tip:</strong> PNG format supports transparency, but JPG images don't have transparency data.
                    The converted PNG will have the same colors as the original.
                </p>
            </Card>
        </div>
    );
