...
export const TOOL_REGISTRY = {
    ...
    pdf: {
        category: 'PDF',
        tools: [
            { id: 'pdf-merger', name: 'Merge PDF', slug: 'pdf-merger' },
            { id: 'pdf-splitter', name: 'Split PDF', slug: 'pdf-splitter' },
            { id: 'pdf-rotator', name: 'Rotate PDF', slug: 'pdf-rotator' },
            { id: 'pdf-compress', name: 'Compress PDF', slug: 'pdf-compress' },
            { id: 'pdf-from-images', name: 'Image to PDF', slug: 'pdf-from-images' },
            { id: 'pdf-page-numbers', name: 'Add Page Numbers', slug: 'pdf-page-numbers' },
            { id: 'pdf-watermark', name: 'Add Watermark', slug: 'pdf-watermark' },
            { id: 'pdf-protect', name: 'Protect PDF', slug: 'pdf-protect' },
            { id: 'pdf-unlock', name: 'Unlock PDF', slug: 'pdf-unlock' },
            { id: 'pdf-organize', name: 'Organize Pages', slug: 'pdf-organize' },
            { id: 'doc-to-pdf', name: 'Word to PDF', slug: 'doc-to-pdf' },
            { id: 'pdf-to-doc', name: 'PDF to Word', slug: 'pdf-to-doc' },
            { id: 'pdf-to-image', name: 'PDF to Image', slug: 'pdf-to-image' },
            { id: 'text-to-pdf', name: 'Text to PDF', slug: 'text-to-pdf' },
            { id: 'html-to-pdf', name: 'HTML to PDF', slug: 'html-to-pdf' },
            { id: 'pdf-previewer', name: 'PDF Viewer', slug: 'pdf-previewer' },
        ],
    },
    converter: {
        category: 'Converter',
